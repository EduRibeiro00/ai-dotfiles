...
# Syncs skills and rules to OpenCode configuration directory
...
printf "\n${BLUE}=== OpenCode Sync ===${NC}\n\n"

CONFIG_DIR="$HOME/.opencode"

printf "OpenCode Config Directory: ${BLUE}%s${NC}\n\n" "$CONFIG_DIR"
...
printf "${YELLOW}Next: Restart OpenCode to reload the configuration${NC}\n"
